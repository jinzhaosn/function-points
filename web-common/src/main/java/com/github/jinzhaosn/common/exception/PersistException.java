...
public class PersistException extends RuntimeException implements IBaseStatus {
    ...
    public PersistException(IBaseStatus statusEnum) {
        super(statusEnum.getMessage());
        this.code = statusEnum.getCode();
        this.message = statusEnum.getMessage();
    }

    public PersistException(IBaseStatus statusEnum, Throwable cause) {
